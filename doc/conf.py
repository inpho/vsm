...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.todo', 'sphinx.ext.coverage']
                #'ipython_savefig_dir', 'ipython_rgxin', 'ipython_rgout']
...
project = u'vsm'
copyright = u'2013, vsm development team'
...
html_theme_options = {
    ...
    # 'sidebarwidth': '230',
    # (true or false): Put the sidebar on the right side. Defaults to false.
    # 'rightsidebar': 'true',
    ...
    'headbgcolor': '',
    # (CSS color): Text color for headings. 
    'headtextcolor': '',
    # (CSS color): Link color for headings. 
    'headlinkcolor': '',
    # (CSS color): Background color for code blocks. 
    # 'codebgcolor': '',
    # (CSS color): Default text color for code blocks, if not set
    # differently by the highlighting style.
    # 'codetextcolor': '',
    # (CSS font-family): Font for normal text. 
    # 'bodyfont': '',
    # (CSS font-family): Font for headings. 
    # 'headfont': ''
}
