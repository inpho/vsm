...
variations of :doc:`Beagle model<wf_beagle>`.
             
:mod:`LDA Gibbs viewer<vsm.viewer.ldagibbsviewer>` - used with
:class:`LDA Gibbs<vsm.model.ldagibbs.LDAGibbs>` or 
:class:`LDA CGS Multi<vsm.model.ldacgsmulti.LdaCgsMulti>` model.

:mod:`LSA viewer<vsm.viewer.lsaviewer>` - used with
:mod:`LSA model<vsm.model.lsa>` model.

:mod:`Tf viewer<vsm.viewer.tfviewer>` - used with
:class:`Tf Seq<vsm.model.tf.TfSeq>` or 
:class:`Tf Multi<vsm.model.tf.TfMulti>` model.

:mod:`TfIdf viewer<vsm.viewer.tfidfviewer>` - used with the 
:mod:`Tf-Idf model<vsm.model.tfidf>`.

Now, Take your :mod:`vsm.corpus` and :mod:`vsm.model` to
